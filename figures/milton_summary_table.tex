...
\begin{table}[t]
  ...
  \caption{Hurricane Milton (October 2024) case-study summary. Each row
           ...
           maximum-gap setting. IFS-ENS, the only physically-based solver,
           attains the lowest MSL bias ($+36.6$\,hPa); it samples Milton on
           its native $\sim 9$\,km TCo1279 grid before downsampling to
           0.25$^\circ$ for evaluation.}
