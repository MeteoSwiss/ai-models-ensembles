...
echo "   ai-ens verify"
echo ""
echo "For detailed instructions, see QUICKSTART_TEST.md"
echo ""
echo "=========================================="
echo "Known Issues"
echo "=========================================="
echo ""
echo "⚠️  JAX/Haiku Model Loading:"
echo "   If you see errors when loading GraphCast, this is a known"
echo "   compatibility issue with JAX on ARM architecture."
echo "   The models will still work for inference on GPU nodes."
echo ""
echo "   Workaround: Run inference on GPU nodes where JAX is properly"
echo "   configured, or use the Slurm scripts which handle this."
echo ""
