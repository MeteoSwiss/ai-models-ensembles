...
def plot_error_map(errors_mean, errors_unperturbed,
    ...
    errors_mean = errors_mean.expand_dims(
        "member").assign_coords(member=[9998])
    errors_unperturbed = errors_unperturbed.expand_dims(
        "member").assign_coords(member=[9999])
