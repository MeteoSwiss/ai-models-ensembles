...
#SBATCH --output=/capstor/store/cscs/swissai/a122/sadamov/ai-models-ensembles/model_test_logs/sfno_diag_modes.log
#SBATCH --error=/capstor/store/cscs/swissai/a122/sadamov/ai-models-ensembles/model_test_logs/sfno_diag_modes.log
...
srun -N1 -n1 \
  ...
  python tools/diagnose_sfno_modes.py
