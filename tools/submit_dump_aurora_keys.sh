...
#SBATCH --output=/capstor/store/cscs/mch/s83/sadamov/ai-models-ensembles/model_test_logs/aurora_keys.log
#SBATCH --error=/capstor/store/cscs/mch/s83/sadamov/ai-models-ensembles/model_test_logs/aurora_keys.log
