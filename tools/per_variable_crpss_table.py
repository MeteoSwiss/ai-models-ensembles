...
lines.append("")
# Emitted as a FRAGMENT (panel b of the combined CRPSS table): main.tex wraps
# this and headline_8way_table.tex in one \begin{table} float that carries the
# shared caption and \label{tab:headline8way}. No float/caption/label here.
lines.append("{\\footnotesize")
lines.append("\\setlength{\\tabcolsep}{3.5pt}")
lines.append("\\textbf{(b) Per-variable CRPSS at 240\\,h.}\\par\\vspace{3pt}")
