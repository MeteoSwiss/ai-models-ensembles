...
# scratch.
MILTON_CONDA=/capstor/store/cscs/mch/s83/sadamov/miniforge3
...
export MILTON_VENV=/capstor/store/cscs/mch/s83/sadamov/venvs/ai-models-ensembles
export MILTON_PYTHON=$MILTON_VENV/bin/python
